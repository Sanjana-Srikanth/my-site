<script>
	...
	import { applyStyleBlocks } from '$lib/content/styleBlocks.js';
...
{:else if data.content}
	...
	{@const _debug = console.log("BLOG CONTENT PREVIEW:", data.content.content.slice(0, 500))}
		<BlogPostLayout
			title={data.content.metadata.title}
			description={data.content.metadata.description}
			...
			content={applyStyleBlocks(data.content.content)}
